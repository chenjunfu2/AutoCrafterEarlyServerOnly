package chenjunfu2.crafter.screen;
...
import chenjunfu2.crafter.screen.slot.CrafterInputSlot;
...
public class CrafterScreenHandler extends ScreenHandler implements ScreenHandlerListener
{
	...
	public CrafterScreenHandler(int syncId, PlayerInventory playerInventory) {
		...
		this.propertyDelegate = new ArrayPropertyDelegate(CrafterBlockEntity.PROPERTIES_COUNT);
	...
	public boolean isSlotDisabled(int slot) {
		return slot > -1 && slot < CrafterBlockEntity.GRID_SIZE ? this.propertyDelegate.get(slot) == CrafterBlockEntity.SLOT_DISABLED : false;
	}
